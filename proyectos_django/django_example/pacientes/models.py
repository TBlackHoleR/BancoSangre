...
class Pacientes(models.Model):
    ...
    cantidadS = models.ForeignKey(
        Donacion, on_delete=models.CASCADE, verbose_name='Cantidades'
    )
    ...
    def __str__(self):
        ...
        return '%s %s, %s, %s' % (
            self.first_name, self.last_name, self.identification_card, self.cantidadS
        )
